...
def request_and_do_command() -> None:
...
def print_teams_hierarchy(departments: dict) -> None:
    """ принимает словарь департаментов, печатает отделы, принедлжиащие к ним"""
...
def print_teams_info(departments: dict) -> None:
    """ принимает словарь департмаентов, печатает сводную информацию о них"""
    for department, information in departments.items():
...
def create_report(departments: dict) -> None:
    """ принимает словарь департмаентов, сохраняет CSV со сводной информацией о них"""
